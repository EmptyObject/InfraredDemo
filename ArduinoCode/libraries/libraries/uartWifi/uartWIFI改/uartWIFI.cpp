...
bool WIFI::begin(void)
{
	...
	_cell.begin(DefaultBaudRate);	//The default baud rate of ESP8266 is 9600
	
	DebugSerial.begin(DefaultBaudRate);		//The default baud rate for debugging is 9600
	_cell.flush();
...
***************************************************************************/
boolean WIFI::newMux(int type, String addr, int port)
